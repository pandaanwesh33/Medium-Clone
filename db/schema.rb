...
ActiveRecord::Schema[7.0].define(version: 2023_08_13_202458) do
  ...
  create_table "article_revisions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_article_revisions_on_user_id"
  end
  ...
  add_foreign_key "article_revisions", "users"
